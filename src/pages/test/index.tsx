  ...
  return (
    ...
    <div id="page">
        ...
        <div className="header header-fixed header-auto-show header-logo-app">
            <a href="index.html" className="header-title">AZURES</a>
            <a href="#" data-back-button className="header-icon header-icon-1"><i className="fas fa-arrow-right"></i></a>
            <a href="#" data-toggle-theme className="header-icon header-icon-2 show-on-theme-dark"><i className="fas fa-sun"></i></a>
            <a href="#" data-toggle-theme className="header-icon header-icon-2 show-on-theme-light"><i className="fas fa-moon"></i></a>
            <a href="#" data-menu="menu-highlights" className="header-icon header-icon-3"><i className="fas fa-brush"></i></a>
        </div>
        <div id="footer-bar" className="footer-bar-5">
            ...
            <a href="index-settings.html" className="active-nav"><i data-feather="settings" data-feather-line="1" data-feather-size="21" data-feather-color="dark-dark" data-feather-bg="gray-fade-light"></i><span>Settings</span></a>
        </div>
        
        <div className="page-content">
            
            <div className="page-title page-title-small">
                <h2><a href="#" data-back-button><i className="fa fa-arrow-right"></i></a>Settings</h2>
                <a href="#" data-menu="menu-main" className="bg-fade-highlight-light shadow-xl preload-img" data-src="images/avatars/5s.png"></a>
            </div>
            ...
            <div className="card card-style preload-img" data-src="images/pictures/20.jpg">
                <div className="card-body text-center">
                    ...
                    <a href="#" className="btn btn-m rounded-sm btn-border btn-center-l border-white color-white font-700 text-uppercase mb-4">Request Feature</a>
                </div>
                <div className="card-overlay bg-highlight opacity-95"></div>
            </div>
        ...
        <div id="menu-language" className="menu menu-box-bottom menu-box-detached rounded-m" 
             data-menu-height="345" 
             data-menu-effect="menu-over">
            <div className="me-3 ms-3 mt-3">
                <div className="float-start">
                <h3 className="font-700 mb-0 pt-1">Language</h3>
                <p className="font-11 mt-n1 color-highlight mb-3">
                    You can direct to multiple languages of your page.
                </p>         
                </div>
                <div className="float-end">
                    <a href="#" className="close-menu"><i className="fa fa-times-circle color-red-dark pt-3 font-18"></i></a>
                </div>
                    <div className="clearfix"></div>
                <div className="list-group list-custom-small">
                    <a href="#"><img className="me-3 mt-n1" width="20" src="images/flags/United-States.png" /><span>English</span><i className="fa fa-angle-left"></i></a>
                    <a href="#"><img className="me-3 mt-n1" width="20" src="images/flags/India.png" /><span>Indian</span><i className="fa fa-angle-left"></i></a>
                    <a href="#"><img className="me-3 mt-n1" width="20" src="images/flags/Germany.png" /><span>German</span><i className="fa fa-angle-left"></i></a>
                    <a href="#"><img className="me-3 mt-n1" width="20" src="images/flags/Italy.png" /><span>Italian</span><i className="fa fa-angle-left"></i></a>
                    <a href="#" className="border-0"><img className="me-3 mt-n1" width="20"  src="images/flags/Spain.png" /><span>Spanish</span><i className="fa fa-angle-left"></i></a>
                </div>
        ...
        <div id="menu-tips-1" 
            ...
            <div className="row mb-0">
                <div className="col-6">
                    <a href="#" className="btn btn-border btn-sm ms-3 rounded-s btn-full shadow-l color-highlight border-highlight close-menu text-uppercase font-700">Close</a>
                </div>
                <div className="col-6">
                    <a data-menu="menu-tips-2" href="#" className="btn btn-sm me-3 rounded-s btn-full shadow-l bg-highlight font-700 text-uppercase">1/5 - Next</a>
                </div>
            </div>
        </div>        
        ...
        <div id="menu-tips-2" 
            ...
            <div className="row mb-0">
                ...
                <div className="col-6">
                    <a data-menu="menu-tips-3" href="#" className="btn btn-sm me-3 rounded-s btn-full shadow-l bg-highlight font-700 text-uppercase">2/5 - Next</a>
                </div>
            </div>
        </div>    
        ...
        <div id="menu-tips-3" 
            ...
            <div className="row mb-0">
                ...
                <div className="col-6">
                    <a data-menu="menu-tips-4" href="#" className="btn btn-sm me-3 rounded-s btn-full shadow-l bg-highlight font-700 text-uppercase">3/5 - Next</a>
                </div>
            </div>
        </div>      
        ...
        <div id="menu-tips-4" 
            ...
            <div className="row mb-0">
                ...
                <div className="col-6">
                    <a data-menu="menu-tips-5" href="#" className="btn btn-sm me-3 rounded-s btn-full shadow-l bg-highlight font-700 text-uppercase">4/5 - Next</a>
                </div>
            </div>
        </div>      
        ...
        <div id="menu-tips-5" 
            ...
            <a href="#" className="close-menu btn btn-m btn-margins rounded-sm btn-full shadow-l bg-highlight text-uppercase font-700">AWesome!</a>
        </div>    
