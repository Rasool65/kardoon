...
const Warranty: FunctionComponent<IPageProps> = ({ title }) => {
  ...
  const [event, updateEvent] = useReducer(
    ...
    },
    {
      ...
      followUpDescription: '',
      calcResult: { calculatePrice: 0, totalPrice: 0, totalReductionValue: 0, totalTax: 0, totalPaymentableAmount: 0 },
      ...
      <div className="container home-warranty-selector">
            ...
            <div className="warranty-selector-details">
              <ul>
                ...
                <li>
                  ...
                  <div>{UtilsHelper.threeDigitSeparator(event.calcResult?.totalPaymentableAmount)}</div>
                </li>
              </ul>
            </div>
          </div>
        ...
        <div className="col-12">
          <div className="payment-price">
            مبلغ : <span>{UtilsHelper.threeDigitSeparator(event.calcResult?.totalPaymentableAmount)}</span> ریال
          </div>
