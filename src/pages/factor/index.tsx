...
const Factor: FunctionComponent<IPageProps> = ({ title }) => {
  ...
  return (
    <>
      <div id="page" className="factor-page">
        <div className="page-content">
          <div ref={factorRef} style={{ direction: 'rtl' }}>
            ...
            <div className="factor-body card card-style p-4">
            ...
            {/* invoice */}
            <div className="factor-description card card-style p-4 ">
