    ...
    <div className="footer" style={{ padding: `${footerMenuVisible ? '0px 15px 90px 15px' : '0px 15px 30px 15px'}` }}>
      <div className="footer card card-style mx-0 mb-0" style={{ paddingBottom: '25px', direction: 'ltr' }}>
        ...
        <div className="text-center mb-3" style={{ marginTop: '30px' }}>
          <div className="icon icon-xs rounded-sm shadow-l mr-1 bg-facebook pointer" style={{ marginRight: '0.35rem' }}>
            <i className="fab fa-facebook-f" />
          </div>
          <div className="icon icon-xs rounded-sm shadow-l mr-1 bg-twitter pointer" style={{ marginRight: '0.35rem' }}>
            <i className="fab fa-twitter" />
          </div>
          <div className="icon icon-xs rounded-sm shadow-l mr-1 bg-phone pointer" style={{ marginRight: '0.35rem' }}>
            <i className="fa fa-phone" />
          </div>
          <div
            data-menu="menu-share"
            className="icon icon-xs rounded-sm mr-1 shadow-l bg-red2-dark pointer"
