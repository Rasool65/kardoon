  ...
  function init_template() {
    ...
    function activate_geolocation() {
      ...
      function geoLocate() {
        ...
        function success(position) {
          ...
          $('.location-map').after(
            '<iframe class="location-map" src="' + mapLinkEmbed + '"></iframe> <div class="clearfix"></div>'
          );
          $('.location-map')
            .parent()
            .after(
    ...
    $('.input-required input[type="email"]').on('focusout', function () {
      if (emailValidator.test($(this).val())) {
        ...
        if ($(this).val() === '') {
          $(this).parent().find('em').html('(اجباری)');
        } else {
          $(this).parent().find('em').html(invalidIcon);
        }
      }
    ...
    function sharingLinks() {
      ...
      $('.shareToLinkedIn').prop(
        'href',
        'https://www.linkedin.com/shareArticle?mini=true&url=' + share_link + '&title=' + share_title + '&summary=&source='
      );
